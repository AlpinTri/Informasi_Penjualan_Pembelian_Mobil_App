      ...
      <ul class="aside-link-wrapper">
        ...
        <li class="aside-link-item">
          ...
          <ul  class="nav-dropdown-wrapper" ref="transactionsCollapse">
            <RouterLink :to="{name: 'cash transactions'}" :class="isActive('cash')" class="dropdown-item">Cash</RouterLink>
            <RouterLink :to="{name: 'credit transactions'}" :class="isActive('credit')" class="dropdown-item">Kredit</RouterLink>
          </ul>
        </li>
        <li class="aside-link-item">
          ...
          <ul class="nav-dropdown-wrapper" ref="masterCollapse">
            <RouterLink :to="{name: 'cars'}" :class="isActive('cars')" class="dropdown-item">Mobil</RouterLink>
            <RouterLink :to="{name: 'customers'}" :class="isActive('customers')" class="dropdown-item">Customer</RouterLink>
            <RouterLink :to="{name: 'credit packages'}" :class="isActive('credit-packages')" class="dropdown-item">Paket Kredit</RouterLink>
            <RouterLink :to="{name: 'users'}" :class="isActive('users')" class="dropdown-item">User</RouterLink>
          </ul>
        </li>
      </ul>
    </div>
...
const isDashboard = computed(() => route.path.split('/').includes('dashboard') ? 'active' : null);
...
const mark = (name) => route.path.split('/').includes(name) ? 'bg-blue' : '';
