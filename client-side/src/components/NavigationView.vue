<template>
  <nav>
    <div class="wrapper-nav-contents">
      <img class="brand-image" src="../../public/mobilesia_logo.png" alt="" srcset="">
      <div class="wrapper-nav-links">
        <RouterLink class="link" :to="{name: 'home'}">Home</RouterLink>
        <RouterLink class="link" :to="{name: 'search'}">Exploration</RouterLink>
      </div>
    </div>
    <RouterLink v-show="!userInfo" class="link" :to="{name: 'login'}">Login</RouterLink>
    <RouterLink v-show="userInfo" class="link" :to="{name: 'admin'}">Dashboard</RouterLink>
  </nav>
  <!-- <nav class="aside">
